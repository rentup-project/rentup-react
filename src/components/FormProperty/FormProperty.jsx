...
import { createProperty, getOneProperty, updateProperty } from "./../../services/Properties.services";
import './FormProperty.css';

export default function FormProperty({ edit, create, propertyId }) {
